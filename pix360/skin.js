...
// Pano2VR 6.0.1/17227
// Filename: PIX.ggsk
// Generated mié ene 16 15:11:05 2019
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._map_1.onclick=function (e) {
			player.openUrl("http:\/\/www.pixvisuals.com.ar\/","PIX Visuals");
		}
		...
		me._map_1.callChildLogicBlocksHotspot_pix_visuals_changenodeid = function(){
			if(me._map_1.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._map_1.ggMarkerInstances.length; i++) {
					if (me._map_1.ggMarkerInstances[i]._pix_visuals.logicBlock_visible) {
						me._map_1.ggMarkerInstances[i]._pix_visuals.logicBlock_visible();
					}
				}
			}
		}
		me._map_1.callChildLogicBlocksHotspot_pix_visuals_varchanged_vis_website = function(){
			if(me._map_1.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._map_1.ggMarkerInstances.length; i++) {
					if (me._map_1.ggMarkerInstances[i]._pix_visuals.logicBlock_visible) {
		...
		me._map_1.ggInitMapMarkers=function(updateMapBounds) {
			L.SkinMarkerLayer = L.Layer.extend({
				...
				onAdd: function(map) {
					...
					this._div.style.left = -225 + 'px';
					this._div.style.top = -157 + 'px';
					this._update();
			...
			for(var i=0;i<ids.length;i++) {
				...
				if ((gps.length>=2) && ((gps[0]!=0) || (gps[1]!=0))) {
					...
					var div=new SkinElement_pix_visuals_Class(me, markerParent);
					marker=new L.SkinMarkerLayer(div._pix_visuals,markerLocation);
		...
		me._map_1.callChildLogicBlocksHotspot_pix_visuals_changenodeid();
		me._map_1.callChildLogicBlocksHotspot_pix_visuals_varchanged_vis_website();
	...
	function SkinElement_pix_visuals_Class(parentScope,ggParent) {
		var me=this;
		var flag=false;
		me.parentScope=parentScope;
		...
		el=me._pix_visuals=document.createElement('div');
		els=me._pix_visuals__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="PIX Visuals";
		el.ggDx=0;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="PIX Visuals";
		el.appendChild(els);
		me._pix_visuals.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			return me.ggNodeId;
		}
		me._pix_visuals.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(player.getVariableValue('vis_website') == true)
			)
			...
			if (me._pix_visuals.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._pix_visuals.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._pix_visuals.style[domTransition]='';
				if (me._pix_visuals.ggCurrentLogicStateVisible == 0) {
					me._pix_visuals.style.visibility=(Number(me._pix_visuals.style.opacity)>0||!me._pix_visuals.style.opacity)?'inherit':'hidden';
					me._pix_visuals.ggVisible=true;
				}
				else {
					me._pix_visuals.style.visibility="hidden";
					me._pix_visuals.ggVisible=false;
				}
			}
		}
		me._pix_visuals.ggUpdatePosition=function (useTransition) {
		}
	};
	...
	player.addListener('changenodeid', function(args) { me._show_controller_button.logicBlock_position();me._loading_multires.logicBlock_visible();me._screentint.logicBlock_alpha();me._controller.logicBlock_position();me._controller.logicBlock_alpha();me._controller_slider.logicBlock_position();me._fullscreen_buttons.logicBlock_position();me._fullscreen_buttons.logicBlock_visible();me._gyro.logicBlock_position();me._gyro.logicBlock_visible();me._gyro_on.logicBlock_alpha();me._gyro_off.logicBlock_alpha();me._tt_gyro.logicBlock_text();me._projection_buttons.logicBlock_position();me._projection_buttons.logicBlock_visible();me._thumbnail.logicBlock_position();me._thumbnail.logicBlock_visible();me._tt_thumbnail_open.logicBlock_text();me._info.logicBlock_position();me._info.logicBlock_visible();me._autorotate_buttons.logicBlock_position();me._autorotate_buttons.logicBlock_visible();me._autorotate_start.logicBlock_alpha();me._autorotate_stop.logicBlock_alpha();me._tt_rotate.logicBlock_text();me._zoomout.logicBlock_visible();me._zoomin.logicBlock_visible();me._thumbnail_menu.logicBlock_position();me._thumbnail_menu.logicBlock_visible();me._thumbnail_menu.logicBlock_alpha();me._thumbnail_menu_mobile.logicBlock_position();me._thumbnail_menu_mobile.logicBlock_visible();me._thumbnail_menu_mobile.logicBlock_alpha();me._userdata.logicBlock_visible();me._information.logicBlock_visible();me._image_popup.logicBlock_visible();me._popup_image.logicBlock_visible();me._video_popup_file.logicBlock_visible();me._popup_video_file.logicBlock_visible();me._video_popup_controls_file.logicBlock_visible();me._video_popup_url.logicBlock_visible();me._popup_video_url.logicBlock_visible();me._video_popup_controls_url.logicBlock_visible();me._video_popup_vimeo.logicBlock_visible();me._popup_video_vimeo.logicBlock_visible();me._video_popup_youtube.logicBlock_visible();me._popup_video_youtube.logicBlock_visible();me.__360image_gyro.logicBlock_visible();me.__360image.logicBlock_position();me.__360image.logicBlock_scaling();me._phone2.logicBlock_scaling();me._phone3.logicBlock_scaling();me._close.logicBlock_visible();me._loading.logicBlock_visible(); });
	...
	player.addListener('varchanged_vis_website', function(args) { me._show_controller_button.logicBlock_position();me._screentint.logicBlock_alpha();me._controller.logicBlock_position();me._thumbnail_menu.logicBlock_position();me._close.logicBlock_visible(); });
	...
	player.addListener('changenodeid', function(args) { me._map_1.callChildLogicBlocksHotspot_pix_visuals_changenodeid(); });
	player.addListener('varchanged_vis_website', function(args) { me._map_1.callChildLogicBlocksHotspot_pix_visuals_varchanged_vis_website(); });
